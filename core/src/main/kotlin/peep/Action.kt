...
sealed class Action {
    ...
    data class WaitForTrain(val stationId: Int) : Action()
    data class RideTrain(val trainId: Int) : Action()
    object Idle : Action()
    ...
    fun targetBuildingId(): Int? = when (this) {
        ...
        is WaitForBus, is RideBus, is WaitForTrain, is RideTrain, Idle -> null
    }
}
